...
class ChartTemplate:
    ...
    def make_chart(self, id:int=None, name:str=None, custom_props=None):
        ...
        return analysis.Chart(type=self.type, name=name, template=self.id, icon=self.icon, script=self.script, dialog_pages=self.dialog_pages.copy(), properties=props)
