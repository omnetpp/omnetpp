...
def copy_properties():
    """
    Queries the configured properties of the chart object, and sets them on the plot.
    This is where the properties configured in the dialog are applied explicitly.
    """
