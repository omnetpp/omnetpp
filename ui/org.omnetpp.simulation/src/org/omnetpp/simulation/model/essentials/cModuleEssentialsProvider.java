...
import static org.omnetpp.simulation.model.FieldNames.FLD_CMODULE_ISSIMPLE;
import static org.omnetpp.simulation.model.FieldNames.FLD_COBJECT_FULLNAME;
...
public class cModuleEssentialsProvider implements IEssentialsProvider {
    ...
    public Object[] getChildren(cObject object) {
        ...
        result.add("C++ type = " + module.getClassName());  //TODO only if nontrivial, e.g. not the same as NED type name, or not cCompoundModule for compound modules
