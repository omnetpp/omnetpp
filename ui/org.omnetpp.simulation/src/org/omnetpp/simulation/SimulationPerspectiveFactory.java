...
public class SimulationPerspectiveFactory implements IPerspectiveFactory {
    ...
    public void createInitialLayout(IPageLayout layout) {
        ...
        leftFolder.addView(IConstants.SIMULATIONOBJECTTREE_VIEW_ID);
        ...
        leftBottomFolder.addPlaceholder(IPageLayout.ID_OUTLINE);

        IFolderLayout bottomFolder = layout.createFolder("bottom", IPageLayout.BOTTOM, (float)0.75, editorArea); //$NON-NLS-1$
        bottomFolder.addView(IConstants.MODULEOUTPUT_VIEW_ID);
        bottomFolder.addView(IConstants.ID_CONSOLE_VIEW);
        bottomFolder.addPlaceholder(IPageLayout.ID_PROBLEM_VIEW);
        bottomFolder.addPlaceholder(IConstants.MODULEHIERARCHY_VIEW_ID);
        bottomFolder.addPlaceholder(IConstants.MODULEPARAMETERS_VIEW_ID);
        bottomFolder.addPlaceholder(IConstants.NEDINHERITANCE_VIEW_ID);
