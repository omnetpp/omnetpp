...
/**
 * This is the item provider adapter for a {@link org.omnetpp.ned.model.emf.Channel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChannelItemProvider
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Channel_bannerComment_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Channel_bannerComment_feature", "_UI_Channel_type"),
                 NedPackage.eINSTANCE.getChannel_BannerComment(),
                 true,
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 NedPackage.eINSTANCE.getChannel_Name(),
                 true,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
                 null,
                 null));
    ...
    protected void addRightCommentPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Channel_rightComment_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Channel_rightComment_feature", "_UI_Channel_type"),
                 NedPackage.eINSTANCE.getChannel_RightComment(),
                 true,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
                 null,
                 null));
    ...
    protected void addTrailingCommentPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Channel_trailingComment_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Channel_trailingComment_feature", "_UI_Channel_type"),
                 NedPackage.eINSTANCE.getChannel_TrailingComment(),
                 true,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
                 null,
                 null));
    ...
    public Collection getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(NedPackage.eINSTANCE.getChannel_ChannelAttr());
            childrenFeatures.add(NedPackage.eINSTANCE.getChannel_DisplayString());
        }
    ...
    protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (NedPackage.eINSTANCE.getChannel_ChannelAttr(),
                 NedFactory.eINSTANCE.createChannelAttr()));

        newChildDescriptors.add
            (createChildParameter
                (NedPackage.eINSTANCE.getChannel_DisplayString(),
