...
/**
 * This is the item provider adapter for a {@link org.omnetpp.ned.model.emf.Param} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Param_bannerComment_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Param_bannerComment_feature", "_UI_Param_type"),
                 NedPackage.eINSTANCE.getParam_BannerComment(),
                 true,
    ...
    protected void addDataTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Param_dataType_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Param_dataType_feature", "_UI_Param_type"),
                 NedPackage.eINSTANCE.getParam_DataType(),
                 true,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
                 null,
                 null));
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 NedPackage.eINSTANCE.getParam_Name(),
                 true,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
                 null,
                 null));
    ...
    protected void addRightCommentPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Param_rightComment_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Param_rightComment_feature", "_UI_Param_type"),
                 NedPackage.eINSTANCE.getParam_RightComment(),
                 true,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
                 null,
                 null));
    ...
    protected void addTrailingCommentPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Param_trailingComment_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Param_trailingComment_feature", "_UI_Param_type"),
                 NedPackage.eINSTANCE.getParam_TrailingComment(),
                 true,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
                 null,
                 null));
