 ...
 * <ul>
 *   <li>{@link org.omnetpp.model.ned2.emf.Channel#getWhitespace <em>Whitespace</em>}</li>
 *   <li>{@link org.omnetpp.model.ned2.emf.Channel#getExtends <em>Extends</em>}</li>
 *   <li>{@link org.omnetpp.model.ned2.emf.Channel#getInterfaceName <em>Interface Name</em>}</li>
 *   <li>{@link org.omnetpp.model.ned2.emf.Channel#getParameters <em>Parameters</em>}</li>
 *   <li>{@link org.omnetpp.model.ned2.emf.Channel#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 ...
 * @generated
 */
public class Channel extends EObjectImpl {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return Ned2Package.Literals.CHANNEL;
	}
	 ...
	 * @see org.omnetpp.model.ned2.emf.Ned2Package#getChannel_Whitespace()
	...
	public EList getWhitespace() {
		if (whitespace == null) {
			whitespace = new EObjectContainmentEList(Whitespace.class, this,
					Ned2Package.CHANNEL__WHITESPACE);
		}
		return whitespace;
	}
	 ...
	 * @see org.omnetpp.model.ned2.emf.Ned2Package#getChannel_Extends()
	...
	public NotificationChain basicSetExtends(Extends newExtends,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Ned2Package.CHANNEL__EXTENDS, oldExtends,
					newExtends);
			if (msgs == null)
				msgs = notification;
			else
	...
	/**
	 * Sets the value of the '{@link org.omnetpp.model.ned2.emf.Channel#getExtends <em>Extends</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
		...
		if (newExtends != extends_) {
			...
			if (extends_ != null)
				msgs = ((InternalEObject) extends_).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Ned2Package.CHANNEL__EXTENDS,
						null, msgs);
			if (newExtends != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ned2Package.CHANNEL__EXTENDS, newExtends, newExtends));
	}
	 ...
	 * @see org.omnetpp.model.ned2.emf.Ned2Package#getChannel_InterfaceName()
	...
	public EList getInterfaceName() {
		if (interfaceName == null) {
			interfaceName = new EObjectContainmentEList(InterfaceName.class,
					this, Ned2Package.CHANNEL__INTERFACE_NAME);
		}
	 ...
	 * @see org.omnetpp.model.ned2.emf.Ned2Package#getChannel_Parameters()
	 * @model containment="true" resolveProxies="false"
	...
	public NotificationChain basicSetParameters(Parameters newParameters,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Ned2Package.CHANNEL__PARAMETERS,
	...
	/**
	 * Sets the value of the '{@link org.omnetpp.model.ned2.emf.Channel#getParameters <em>Parameters</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setParameters(Parameters newParameters) {
		if (newParameters != parameters) {
			...
			if (parameters != null)
				msgs = ((InternalEObject) parameters).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- Ned2Package.CHANNEL__PARAMETERS, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ned2Package.CHANNEL__PARAMETERS, newParameters,
					newParameters));
	}
	 ...
	 * @see #setName(String)
	 * @see org.omnetpp.model.ned2.emf.Ned2Package#getChannel_Name()
	...
	/**
	 * Sets the value of the '{@link org.omnetpp.model.ned2.emf.Channel#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ned2Package.CHANNEL__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case Ned2Package.CHANNEL__WHITESPACE:
			return ((InternalEList) getWhitespace())
					.basicRemove(otherEnd, msgs);
		case Ned2Package.CHANNEL__EXTENDS:
			return basicSetExtends(null, msgs);
		case Ned2Package.CHANNEL__INTERFACE_NAME:
			return ((InternalEList) getInterfaceName()).basicRemove(otherEnd,
					msgs);
		case Ned2Package.CHANNEL__PARAMETERS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case Ned2Package.CHANNEL__NAME:
			return getName();
		}
