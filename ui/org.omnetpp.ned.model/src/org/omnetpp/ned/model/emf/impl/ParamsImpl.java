 ...
 * <ul>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.ParamsImpl#getParam <em>Param</em>}</li>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.ParamsImpl#getBannerComment <em>Banner Comment</em>}</li>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.ParamsImpl#getRightComment <em>Right Comment</em>}</li>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.ParamsImpl#getTrailingComment <em>Trailing Comment</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParamsImpl extends EObjectImpl implements Params {
    ...
    protected EClass eStaticClass() {
        return NedPackage.eINSTANCE.getParams();
    }
    ...
    public EList getParam() {
        if (param == null) {
            param = new EObjectContainmentEList(Param.class, this, NedPackage.PARAMS__PARAM);
        }
        return param;
    }
    ...
    public void setBannerComment(String newBannerComment) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, NedPackage.PARAMS__BANNER_COMMENT, oldBannerComment, bannerComment));
    }
    ...
    public void setRightComment(String newRightComment) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, NedPackage.PARAMS__RIGHT_COMMENT, oldRightComment, rightComment));
    }
    ...
    public void setTrailingComment(String newTrailingComment) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, NedPackage.PARAMS__TRAILING_COMMENT, oldTrailingComment, trailingComment));
    }
