...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Submodules</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.SubmodulesImpl#getSubmodule <em>Submodule</em>}</li>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.SubmodulesImpl#getBannerComment <em>Banner Comment</em>}</li>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.SubmodulesImpl#getRightComment <em>Right Comment</em>}</li>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.SubmodulesImpl#getTrailingComment <em>Trailing Comment</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SubmodulesImpl extends EObjectImpl implements Submodules {
    /**
    ...
    protected EClass eStaticClass() {
        return NedPackage.eINSTANCE.getSubmodules();
    }
    ...
    public EList getSubmodule() {
        if (submodule == null) {
            submodule = new EObjectContainmentEList(Submodule.class, this, NedPackage.SUBMODULES__SUBMODULE);
        }
        return submodule;
    }
    ...
    public void setBannerComment(String newBannerComment) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, NedPackage.SUBMODULES__BANNER_COMMENT, oldBannerComment, bannerComment));
    }
    ...
    public void setRightComment(String newRightComment) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, NedPackage.SUBMODULES__RIGHT_COMMENT, oldRightComment, rightComment));
    }
    ...
    public void setTrailingComment(String newTrailingComment) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, NedPackage.SUBMODULES__TRAILING_COMMENT, oldTrailingComment, trailingComment));
    }
