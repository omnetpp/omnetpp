...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Substparams</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.SubstparamsImpl#getSubstparam <em>Substparam</em>}</li>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.SubstparamsImpl#getBannerComment <em>Banner Comment</em>}</li>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.SubstparamsImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.SubstparamsImpl#getRightComment <em>Right Comment</em>}</li>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.SubstparamsImpl#getTrailingComment <em>Trailing Comment</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SubstparamsImpl extends EObjectImpl implements Substparams {
    /**
     * The cached value of the '{@link #getSubstparam() <em>Substparam</em>}' containment reference list.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #getSubstparam()
     * @generated
     * @ordered
     */
    protected EList substparam = null;
    ...
    protected EClass eStaticClass() {
        return NedPackage.eINSTANCE.getSubstparams();
    }
     ...
     * @generated
     */
    public EList getSubstparam() {
        if (substparam == null) {
            substparam = new EObjectContainmentEList(Substparam.class, this, NedPackage.SUBSTPARAMS__SUBSTPARAM);
        }
        return substparam;
    }
    ...
    public void setBannerComment(String newBannerComment) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, NedPackage.SUBSTPARAMS__BANNER_COMMENT, oldBannerComment, bannerComment));
    }
    ...
    public void setCondition(String newCondition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, NedPackage.SUBSTPARAMS__CONDITION, oldCondition, condition));
    }
    ...
    public void setRightComment(String newRightComment) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, NedPackage.SUBSTPARAMS__RIGHT_COMMENT, oldRightComment, rightComment));
    }
    ...
    public void setTrailingComment(String newTrailingComment) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, NedPackage.SUBSTPARAMS__TRAILING_COMMENT, oldTrailingComment, trailingComment));
    }
        ...
        if (featureID >= 0) {
            switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
                case NedPackage.SUBSTPARAMS__SUBSTPARAM:
                    return ((InternalEList)getSubstparam()).basicRemove(otherEnd, msgs);
                default:
    ...
    public void eSet(EStructuralFeature eFeature, Object newValue) {
        switch (eDerivedStructuralFeatureID(eFeature)) {
            case NedPackage.SUBSTPARAMS__SUBSTPARAM:
                getSubstparam().clear();
                getSubstparam().addAll((Collection)newValue);
                return;
            case NedPackage.SUBSTPARAMS__BANNER_COMMENT:
    ...
    public boolean eIsSet(EStructuralFeature eFeature) {
        switch (eDerivedStructuralFeatureID(eFeature)) {
            case NedPackage.SUBSTPARAMS__SUBSTPARAM:
                return substparam != null && !substparam.isEmpty();
            case NedPackage.SUBSTPARAMS__BANNER_COMMENT:
