...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Substparam</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.SubstparamImpl#getBannerComment <em>Banner Comment</em>}</li>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.SubstparamImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.SubstparamImpl#getRightComment <em>Right Comment</em>}</li>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.SubstparamImpl#getTrailingComment <em>Trailing Comment</em>}</li>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.SubstparamImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SubstparamImpl extends EObjectImpl implements Substparam {
    /**
    ...
    protected EClass eStaticClass() {
        return NedPackage.eINSTANCE.getSubstparam();
    }
    ...
    public void setBannerComment(String newBannerComment) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, NedPackage.SUBSTPARAM__BANNER_COMMENT, oldBannerComment, bannerComment));
    }
    ...
    public void setName(String newName) {
        ...
        name = newName;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, NedPackage.SUBSTPARAM__NAME, oldName, name));
    }
    ...
    public void setRightComment(String newRightComment) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, NedPackage.SUBSTPARAM__RIGHT_COMMENT, oldRightComment, rightComment));
    }
    ...
    public void setTrailingComment(String newTrailingComment) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, NedPackage.SUBSTPARAM__TRAILING_COMMENT, oldTrailingComment, trailingComment));
    }
    ...
    public void setValue(String newValue) {
        ...
        value = newValue;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, NedPackage.SUBSTPARAM__VALUE, oldValue, value));
    }
    ...
    public Object eGet(EStructuralFeature eFeature, boolean resolve) {
        switch (eDerivedStructuralFeatureID(eFeature)) {
            case NedPackage.SUBSTPARAM__BANNER_COMMENT:
                return getBannerComment();
            case NedPackage.SUBSTPARAM__NAME:
                return getName();
            case NedPackage.SUBSTPARAM__RIGHT_COMMENT:
                return getRightComment();
            case NedPackage.SUBSTPARAM__TRAILING_COMMENT:
                return getTrailingComment();
            case NedPackage.SUBSTPARAM__VALUE:
                return getValue();
        }
