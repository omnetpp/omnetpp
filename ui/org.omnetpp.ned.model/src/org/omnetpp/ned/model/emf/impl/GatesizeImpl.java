...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Gatesize</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.GatesizeImpl#getBannerComment <em>Banner Comment</em>}</li>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.GatesizeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.GatesizeImpl#getRightComment <em>Right Comment</em>}</li>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.GatesizeImpl#getTrailingComment <em>Trailing Comment</em>}</li>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.GatesizeImpl#getVectorSize <em>Vector Size</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class GatesizeImpl extends EObjectImpl implements Gatesize {
    /**
    ...
    protected EClass eStaticClass() {
        return NedPackage.eINSTANCE.getGatesize();
    }
    ...
    public void setBannerComment(String newBannerComment) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, NedPackage.GATESIZE__BANNER_COMMENT, oldBannerComment, bannerComment));
    }
    ...
    public void setName(String newName) {
        ...
        name = newName;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, NedPackage.GATESIZE__NAME, oldName, name));
    }
    ...
    public void setRightComment(String newRightComment) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, NedPackage.GATESIZE__RIGHT_COMMENT, oldRightComment, rightComment));
    }
    ...
    public void setTrailingComment(String newTrailingComment) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, NedPackage.GATESIZE__TRAILING_COMMENT, oldTrailingComment, trailingComment));
    }
    ...
    public void setVectorSize(String newVectorSize) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, NedPackage.GATESIZE__VECTOR_SIZE, oldVectorSize, vectorSize));
    }
    ...
    public Object eGet(EStructuralFeature eFeature, boolean resolve) {
        switch (eDerivedStructuralFeatureID(eFeature)) {
            case NedPackage.GATESIZE__BANNER_COMMENT:
                return getBannerComment();
            case NedPackage.GATESIZE__NAME:
                return getName();
            case NedPackage.GATESIZE__RIGHT_COMMENT:
                return getRightComment();
            case NedPackage.GATESIZE__TRAILING_COMMENT:
                return getTrailingComment();
            case NedPackage.GATESIZE__VECTOR_SIZE:
