...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Conn Attr</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.ConnAttrImpl#getBannerComment <em>Banner Comment</em>}</li>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.ConnAttrImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.ConnAttrImpl#getRightComment <em>Right Comment</em>}</li>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.ConnAttrImpl#getTrailingComment <em>Trailing Comment</em>}</li>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.ConnAttrImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ConnAttrImpl extends EObjectImpl implements ConnAttr {
    /**
    ...
    protected EClass eStaticClass() {
        return NedPackage.eINSTANCE.getConnAttr();
    }
    ...
    public void setBannerComment(String newBannerComment) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, NedPackage.CONN_ATTR__BANNER_COMMENT, oldBannerComment, bannerComment));
    }
    ...
    public void setName(String newName) {
        ...
        name = newName;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, NedPackage.CONN_ATTR__NAME, oldName, name));
    }
    ...
    public void setRightComment(String newRightComment) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, NedPackage.CONN_ATTR__RIGHT_COMMENT, oldRightComment, rightComment));
    }
    ...
    public void setTrailingComment(String newTrailingComment) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, NedPackage.CONN_ATTR__TRAILING_COMMENT, oldTrailingComment, trailingComment));
    }
    ...
    public void setValue(String newValue) {
        ...
        value = newValue;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, NedPackage.CONN_ATTR__VALUE, oldValue, value));
    }
    ...
    public Object eGet(EStructuralFeature eFeature, boolean resolve) {
        switch (eDerivedStructuralFeatureID(eFeature)) {
            case NedPackage.CONN_ATTR__BANNER_COMMENT:
                return getBannerComment();
            case NedPackage.CONN_ATTR__NAME:
                return getName();
            case NedPackage.CONN_ATTR__RIGHT_COMMENT:
                return getRightComment();
            case NedPackage.CONN_ATTR__TRAILING_COMMENT:
                return getTrailingComment();
            case NedPackage.CONN_ATTR__VALUE:
                return getValue();
        }
