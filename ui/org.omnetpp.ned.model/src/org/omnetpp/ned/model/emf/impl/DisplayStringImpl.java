...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Display String</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.DisplayStringImpl#getBannerComment <em>Banner Comment</em>}</li>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.DisplayStringImpl#getRightComment <em>Right Comment</em>}</li>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.DisplayStringImpl#getTrailingComment <em>Trailing Comment</em>}</li>
 *   <li>{@link org.omnetpp.ned.model.emf.impl.DisplayStringImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DisplayStringImpl extends EObjectImpl implements DisplayString {
    /**
    ...
    protected EClass eStaticClass() {
        return NedPackage.eINSTANCE.getDisplayString();
    }
    ...
    public void setBannerComment(String newBannerComment) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, NedPackage.DISPLAY_STRING__BANNER_COMMENT, oldBannerComment, bannerComment));
    }
    ...
    public void setRightComment(String newRightComment) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, NedPackage.DISPLAY_STRING__RIGHT_COMMENT, oldRightComment, rightComment));
    }
    ...
    public void setTrailingComment(String newTrailingComment) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, NedPackage.DISPLAY_STRING__TRAILING_COMMENT, oldTrailingComment, trailingComment));
    }
    ...
    public void setValue(String newValue) {
        ...
        value = newValue;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, NedPackage.DISPLAY_STRING__VALUE, oldValue, value));
    }
