...
public class ScheduleMessageAnimation extends AbstractAnimationPrimitive {
    ...
    public ScheduleMessageAnimation(AnimationController animationEnvironment, int moduleId, EventLogMessage message) {
