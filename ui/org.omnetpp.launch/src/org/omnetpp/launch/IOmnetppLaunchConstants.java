...
public interface IOmnetppLaunchConstants {
    public static final String OMNETPP_LAUNCH_ID = "org.eclipse.cdt.launch"; //$NON-NLS-1$

    /**
     * Launch configuration attribute key. The value is a name of a C/C++
     * project associated with a C/C++ launch configuration.
     */
    public static final String ATTR_PROJECT_NAME = OMNETPP_LAUNCH_ID + ".PROJECT_ATTR"; //$NON-NLS-1$

    /**
     * Launch configuration attribute key. The value is a string specifying
     * application a C/C++ launch configuration.
     */
    public static final String ATTR_PROGRAM_NAME = OMNETPP_LAUNCH_ID + ".PROGRAM_NAME"; //$NON-NLS-1$
     ...
     */
    public static final String ATTR_PROGRAM_ARGUMENTS = OMNETPP_LAUNCH_ID + ".PROGRAM_ARGUMENTS"; //$NON-NLS-1$
     ...
     */
    public static final String ATTR_WORKING_DIRECTORY = OMNETPP_LAUNCH_ID + ".WORKING_DIRECTORY"; //$NON-NLS-1$
}
