...
public class ExportChartsAction extends AbstractScaveAction {
    ...
    protected void doRun(ScaveEditor editor, ISelection selection) throws CoreException {
        ...
        final List<Chart> allCharts = ScaveModelUtil.collectCharts(editor.getAnalysis().getRootFolder().getItems());
        ...
        if (dialog.open() == Window.OK) {
            try {
                ...
                if (!result.selectedCharts.isEmpty()) {
                    ...
                    ChartExport.exportCharts(result.selectedCharts, editor.getScriptsOfOpenCharts(), extraProperties, chartsDir,
