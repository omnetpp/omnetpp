...
public enum PlotProperty {
    ...
    PROP_X_AXIS_SHOW_TITLE("X.Axis.Title.Show", Boolean.class, true),
    PROP_X_AXIS_SHOW_LABELS("X.Axis.Labels.Show", Boolean.class, true),
    ...
    PROP_Y_AXIS_SHOW_TITLE("Y.Axis.Title.Show", Boolean.class, true),
    PROP_Y_AXIS_SHOW_LABELS("Y.Axis.Labels.Show", Boolean.class, true),
