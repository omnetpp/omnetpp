...
/**
 * This is the item provider adapter for a {@link org.omnetpp.ned2.model.Property} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PropertyItemProvider extends ItemProviderAdapter implements
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_Property_name_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Property_name_feature", "_UI_Property_type"),
				Ned2Package.Literals.PROPERTY__NAME, true,
	...
	protected void addQualifierPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Property_qualifier_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Property_qualifier_feature", "_UI_Property_type"),
				Ned2Package.Literals.PROPERTY__QUALIFIER, true,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Ned2Package.Literals.PROPERTY__WHITESPACE);
			childrenFeatures.add(Ned2Package.Literals.PROPERTY__KEY_VALUE);
			childrenFeatures.add(Ned2Package.Literals.PROPERTY__PROPERTY);
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors,
		...
		newChildDescriptors.add(createChildParameter(
				Ned2Package.Literals.PROPERTY__WHITESPACE,
				Ned2Factory.eINSTANCE.createWhitespace()));

		newChildDescriptors.add(createChildParameter(
				Ned2Package.Literals.PROPERTY__KEY_VALUE, Ned2Factory.eINSTANCE
						.createKeyValue()));

		newChildDescriptors.add(createChildParameter(
				Ned2Package.Literals.PROPERTY__PROPERTY, Ned2Factory.eINSTANCE
						.createProperty()));
	}
