 ...
 */
public class EventLogAnimationPlugin extends AbstractUIPlugin {
	// The plug-in ID
	public static String PLUGIN_ID;

	// The shared instance
	private static EventLogAnimationPlugin plugin;

	/**
	 * The constructor
	 */
	public EventLogAnimationPlugin() {
		plugin = this;
	}
	 ...
	 */
	public static EventLogAnimationPlugin getDefault() {
		return plugin;
	}
