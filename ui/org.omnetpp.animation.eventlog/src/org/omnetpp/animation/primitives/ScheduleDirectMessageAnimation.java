...
public class ScheduleDirectMessageAnimation extends AbstractInstantaneousAnimation {
    protected static Image image = new Image(null, AnimationCorePlugin.getImageDescriptor(AnimationContributor.IMAGE_SCHEDULE_MESSAGE).getImageData());
    ...
    public ScheduleDirectMessageAnimation(AnimationController animationEnvironment, long eventNumber, BigDecimal simulationTime, int moduleId, MessageModel message) {
