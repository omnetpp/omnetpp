...
public class NewInifileWizard extends Wizard implements INewWizard {
	private NewInifileWizardPage page;
	private ISelection selection;

	/**
	 * Constructor for NewInifileWizard.
	 */
	...
	public void addPages() {
		page = new NewInifileWizardPage(selection);
		addPage(page);
	}
	...
	private void throwCoreException(String message) throws CoreException {
		IStatus status = new Status(IStatus.ERROR, InifileEditorPlugin.PLUGIN_ID, IStatus.OK, message, null);
