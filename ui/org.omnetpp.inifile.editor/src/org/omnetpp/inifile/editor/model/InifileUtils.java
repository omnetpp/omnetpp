...
//
//		/* for convenience */
//		public ParameterData(ParamResolutionType type, NEDElement element, String moduleFullPath, String parameterName, String value, String remark) {
//			this.type = type;
...
//				resultList.add(new ParameterData(ParamResolutionType.UNASSIGNED_PAR, param, moduleFullPath, param.getName(), "", "unassigned"));
//			}
...
//				String remark;
//				if (nedValue!=null && iniValue==null) {
//					type = ParamResolutionType.NED_PAR;
//					value = nedValue; 
//					remark = "NED";  //XXX default(x) or not??
//				}
//				else if (nedValue==null && iniValue!=null) {
//					type = ParamResolutionType.INI_PAR;
//					value = iniValue;
//					remark = "ini file";
//				}
//				else if (nedValue.equals(iniValue)) {
//					type = ParamResolutionType.INI_PAR_REDUNDANT;
//					value = nedValue;
...
//		list.add(new ParameterData(ParamResolutionType.ERROR, null, moduleFullPath, "", "", "no such module type: "+moduleTypeName));
//	}
}
