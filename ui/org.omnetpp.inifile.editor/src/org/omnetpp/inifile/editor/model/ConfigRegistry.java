...
public class ConfigRegistry {
    ...
    public static final ConfigOption CFGID_CMDENV_EV_OUTPUT = addPerObjectOption(
        ...
        "(EV<<, EV_INFO, etc.) from the selected modules.");
    ...
    public static final ConfigOption CFGID_CMDENV_LOG_LEVEL = addPerRunOption(
        "cmdenv-log-level", CFG_STRING, "DEBUG",
        ...
        "GLOBAL_COMPILETIME_LOGLEVEL macro that is used to completely remove log " +
    ...
    public static final ConfigOption CFGID_LOG_LEVEL = addPerObjectOption(
        "log-level", KIND_MODULE, CFG_STRING, "TRACE",
        ...
        "log level and the GLOBAL_COMPILETIME_LOGLEVEL macro that is used to " +
