...
public abstract class IncrementalCompletionProcessor extends TemplateCompletionProcessor {
    ...
    protected Image getImage(Template template) {
        ImageRegistry registry = InifileEditorPlugin.getDefault().getImageRegistry();
        Image image = registry.get(DEFAULT_IMAGE);
//        if (image == null) {
//            ImageDescriptor desc= InifileEditorPlugin.imageDescriptorFromPlugin(DEFAULT_IMAGE); //$NON-NLS-1$
