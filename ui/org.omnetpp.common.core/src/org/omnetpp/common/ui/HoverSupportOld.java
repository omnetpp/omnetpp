...
public class HoverSupportOld {
	 ...
	 */
	public HoverSupportOld() {
	}

	/**
	 * Create a hover support object.
	 */
	public HoverSupportOld(IHoverTextProvider defaultHoverTextProvider) {
				...
				if (BrowserInformationControl.isAvailable(parent))
				    return (new BrowserInformationControl(parent, null, AFFORDANCE) {
				        ...
				        public IInformationControlCreator getInformationPresenterControlCreator() {
				            return HoverSupportOld.getInformationPresenterControlCreator();
				        }
				    });
				else
