...
public class PropertyImpl extends EObjectImpl implements Property {
    ...
    protected EClass eStaticClass() {
        return ScaveModelPackage.Literals.PROPERTY;
    }
    ...
    public void setName(String newName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ScaveModelPackage.PROPERTY__NAME, oldName, name));
    }
    ...
    public void setValue(String newValue) {
        ...
        value = newValue;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ScaveModelPackage.PROPERTY__VALUE, oldValue, value));
    }
