 ...
 * @generated
 */
public class AddImpl extends AddDiscardOpImpl implements Add {
    /**
    ...
    protected EClass eStaticClass() {
        return ScaveModelPackage.Literals.ADD;
    }
    ...
    public EList<Except> getExcepts() {
        if (excepts == null) {
            excepts = new EObjectContainmentEList<Except>(Except.class, this, ScaveModelPackage.ADD__EXCEPTS);
        }
        return excepts;
    }
