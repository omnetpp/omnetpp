 ...
 * @generated
 */
public class InputFileImpl extends EObjectImpl implements InputFile {
    /**
    ...
    public void setName(String newName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ScaveModelPackage.INPUT_FILE__NAME, oldName, name));
    }
