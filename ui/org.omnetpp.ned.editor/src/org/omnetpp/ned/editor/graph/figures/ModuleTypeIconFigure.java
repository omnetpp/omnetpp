 ...
 * @author andras
 */
public class ModuleTypeIconFigure extends Figure {
    ...
    private int decoratorImageWidth;
    private int decoratorImageHeight;

	public ModuleTypeIconFigure() {
	}
    ...
    public void setDecorationImage(Image image) {
        ...
        if (image == null)
            decoratorImageHeight = decoratorImageWidth = 0;
        else {
            org.eclipse.swt.graphics.Rectangle imageBounds = decoratorImage.getBounds();
            decoratorImageWidth = imageBounds.width;
            decoratorImageHeight = imageBounds.height;
        }
    ...
    public Dimension getPreferredSize(int wHint, int hHint) {
        return new Dimension(targetWidth + decoratorImageWidth/4 + 1, targetHeight + decoratorImageHeight/4 + 3);
    }
	...
	public void paint(Graphics graphics) {
		...
		centerLoc.y += decoratorImageHeight/4;
		...
		if (decoratorImage != null) {
			graphics.drawImage(decoratorImage, targetWidth - 3*decoratorImageWidth/4, 0);
		}
	}
}
