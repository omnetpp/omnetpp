 ...
 */
public class MsgEditorPlugin extends AbstractUIPlugin {

    // The plug-in ID
    public static final String PLUGIN_ID = "org.omnetpp.msg.editor";
     ...
     */
    public static MsgEditorPlugin getDefault() {
        return plugin;
    }
