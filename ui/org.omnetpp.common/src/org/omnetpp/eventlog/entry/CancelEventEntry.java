...
public class CancelEventEntry extends MessageDescriptionEntry
{

    public CancelEventEntry() {
    }

    public CancelEventEntry(IChunk chunk, int entryIndex) {
    ...
    public String getAsString() { return "CE"; }
    ...
    public String getClassName() { return "CancelEventEntry"; }
}
