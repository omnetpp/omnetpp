...
public class ReferenceRemovedEntry extends ReferenceEntry
{

    public ReferenceRemovedEntry() {
    }

    public ReferenceRemovedEntry(IChunk chunk, int entryIndex) {
    ...
    public String getAsString() { return "RR"; }
    ...
    public String getClassName() { return "ReferenceRemovedEntry"; }
}
