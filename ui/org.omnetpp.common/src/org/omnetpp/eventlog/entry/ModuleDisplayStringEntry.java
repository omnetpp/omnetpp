...
public class ModuleDisplayStringEntry extends ModuleReferenceEntry
{
    public String displayString;

    public ModuleDisplayStringEntry() {
        displayString = null;
    }

    public ModuleDisplayStringEntry(IChunk chunk, int entryIndex) {
    ...
    public String getClassName() { return "ModuleDisplayStringEntry"; }
}
