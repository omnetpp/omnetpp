...
public class GateCreatedEntry extends GateDescriptionEntry
{

    public GateCreatedEntry() {
    }

    public GateCreatedEntry(IChunk chunk, int entryIndex) {
    ...
    public String getAsString() { return "GC"; }
    ...
    public String getClassName() { return "GateCreatedEntry"; }
}
