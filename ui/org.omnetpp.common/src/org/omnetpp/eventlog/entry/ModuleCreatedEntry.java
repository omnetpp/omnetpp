...
public class ModuleCreatedEntry extends ModuleDescriptionEntry
{

    public ModuleCreatedEntry() {
    }

    public ModuleCreatedEntry(IChunk chunk, int entryIndex) {
    ...
    public String getAsString() { return "MC"; }
    ...
    public String getClassName() { return "ModuleCreatedEntry"; }
}
