...
public class DeleteMessageEntry extends MessageDescriptionEntry
{

    public DeleteMessageEntry() {
    }

    public DeleteMessageEntry(IChunk chunk, int entryIndex) {
    ...
    public String getAsString() { return "DM"; }
    ...
    public String getClassName() { return "DeleteMessageEntry"; }
}
