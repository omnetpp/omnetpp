...
public class ReferenceFoundEntry extends ReferenceEntry
{

    public ReferenceFoundEntry() {
    }

    public ReferenceFoundEntry(IChunk chunk, int entryIndex) {
    ...
    public String getAsString() { return "RF"; }
    ...
    public String getClassName() { return "ReferenceFoundEntry"; }
}
