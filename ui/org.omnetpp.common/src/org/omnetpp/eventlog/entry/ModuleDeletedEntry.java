...
public class ModuleDeletedEntry extends ModuleReferenceEntry
{

    public ModuleDeletedEntry() {
    }

    public ModuleDeletedEntry(IChunk chunk, int entryIndex) {
    ...
    public String getAsString() { return "MD"; }
    ...
    public String getClassName() { return "ModuleDeletedEntry"; }
}
