...
public class GateDeletedEntry extends GateReferenceEntry
{

    public GateDeletedEntry() {
    }

    public GateDeletedEntry(IChunk chunk, int entryIndex) {
    ...
    public String getAsString() { return "GD"; }
    ...
    public String getClassName() { return "GateDeletedEntry"; }
}
