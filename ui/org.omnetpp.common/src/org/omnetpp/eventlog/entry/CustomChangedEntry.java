...
public class CustomChangedEntry extends CustomDescriptionEntry
{

    public CustomChangedEntry() {
    }

    public CustomChangedEntry(IChunk chunk, int entryIndex) {
    ...
    public String getAsString() { return "CUM"; }
    ...
    public String getClassName() { return "CustomChangedEntry"; }
}
