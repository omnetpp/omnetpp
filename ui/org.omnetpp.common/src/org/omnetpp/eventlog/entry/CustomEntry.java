...
public class CustomEntry extends CustomDescriptionEntry
{

    public CustomEntry() {
    }

    public CustomEntry(IChunk chunk, int entryIndex) {
    ...
    public String getAsString() { return "CU"; }
    ...
    public String getClassName() { return "CustomEntry"; }
}
