...
public class GateDisplayStringChangedEntry extends GateDisplayStringEntry
{

    public GateDisplayStringChangedEntry() {
    }

    public GateDisplayStringChangedEntry(IChunk chunk, int entryIndex) {
    ...
    public String getAsString() { return "GDC"; }
    ...
    public String getClassName() { return "GateDisplayStringChangedEntry"; }
}
