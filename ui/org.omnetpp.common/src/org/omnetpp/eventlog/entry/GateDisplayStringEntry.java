...
public class GateDisplayStringEntry extends GateReferenceEntry
{
    public String displayString;

    public GateDisplayStringEntry() {
        displayString = null;
    }

    public GateDisplayStringEntry(IChunk chunk, int entryIndex) {
    ...
    public String getClassName() { return "GateDisplayStringEntry"; }
}
