...
public class ConnectionCreatedEntry extends ConnectionDescriptionEntry
{

    public ConnectionCreatedEntry() {
    }

    public ConnectionCreatedEntry(IChunk chunk, int entryIndex) {
    ...
    public String getAsString() { return "CC"; }
    ...
    public String getClassName() { return "ConnectionCreatedEntry"; }
}
