...
public class ModuleDisplayStringChangedEntry extends ModuleDisplayStringEntry
{

    public ModuleDisplayStringChangedEntry() {
    }

    public ModuleDisplayStringChangedEntry(IChunk chunk, int entryIndex) {
    ...
    public String getAsString() { return "MDC"; }
    ...
    public String getClassName() { return "ModuleDisplayStringChangedEntry"; }
}
