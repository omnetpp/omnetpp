...
public class MessageFoundEntry extends MessageDescriptionEntry
{

    public MessageFoundEntry() {
    }

    public MessageFoundEntry(IChunk chunk, int entryIndex) {
    ...
    public String getAsString() { return "EF"; }
    ...
    public String getClassName() { return "MessageFoundEntry"; }
}
