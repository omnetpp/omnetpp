...
public class MessageDisplayStringEntry extends MessageReferenceEntry
{
    public String displayString;

    public MessageDisplayStringEntry() {
        displayString = null;
    }

    public MessageDisplayStringEntry(IChunk chunk, int entryIndex) {
    ...
    public String getClassName() { return "MessageDisplayStringEntry"; }
}
