...
public class ReferenceAddedEntry extends ReferenceEntry
{

    public ReferenceAddedEntry() {
    }

    public ReferenceAddedEntry(IChunk chunk, int entryIndex) {
    ...
    public String getAsString() { return "RA"; }
    ...
    public String getClassName() { return "ReferenceAddedEntry"; }
}
