...
public class CreateMessageEntry extends MessageDescriptionEntry
{

    public CreateMessageEntry() {
    }

    public CreateMessageEntry(IChunk chunk, int entryIndex) {
    ...
    public String getAsString() { return "CM"; }
    ...
    public String getClassName() { return "CreateMessageEntry"; }
}
