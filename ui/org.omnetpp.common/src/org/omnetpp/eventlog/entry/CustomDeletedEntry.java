...
public class CustomDeletedEntry extends CustomReferenceEntry
{

    public CustomDeletedEntry() {
    }

    public CustomDeletedEntry(IChunk chunk, int entryIndex) {
    ...
    public String getAsString() { return "CUD"; }
    ...
    public String getClassName() { return "CustomDeletedEntry"; }
}
