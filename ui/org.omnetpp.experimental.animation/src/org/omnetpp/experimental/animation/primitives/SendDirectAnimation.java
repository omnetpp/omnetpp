 ...
 */
public class SendDirectAnimation extends AbstractAnimationPrimitive {
	...
	public SendDirectAnimation(ReplayAnimationController animationController, 
		...
		this.endSimulationTime = simulationTime + transmissionTime + propagationTime;
	...
	public void redo() {
		SubmoduleFigure senderModuleFigure = (SubmoduleFigure)animationEnvironment.getFigure(senderModuleId);
		SubmoduleFigure destModuleFigure = (SubmoduleFigure)animationEnvironment.getFigure(destModuleId);
	...
	public void animateAt(long eventNumber, double simulationTime, long animationNumber, double animationTime) {
		...
		SubmoduleFigure destModuleFigure = (SubmoduleFigure)animationEnvironment.getFigure(destModuleId);
		if (senderModuleFigure!=null && destModuleFigure!=null) {
			Point p1 = senderModuleFigure.getBounds().getCenter();
			Point p2 = destModuleFigure.getBounds().getCenter();
