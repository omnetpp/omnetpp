...
{\opp} supports a process-style\index{module!process-style} description
method for describing activities. During simulation execution,
simple\index{module!simple} module functions appear to run in parallel,
because they are implemented as coroutines\index{module!coroutine} (also
...
diagrams\index{state-transition diagram|see{finite state machine}} or Petri
nets\index{petri nets}.
