...
Suppose we have a module in the network universityLan, compound
module fddiRing, simple module station[10]. If you call the functions
...
ev << module->fullPath(); // --> "universityLan.fddiRing.station[10]"
\end{verbatim}
...
void FDDIStation::activity()
{
    ...
    ev << buffer->fullPath(); // --> "universityLan.fddiRing.
                              // station[10].buffer"
}
\end{verbatim}
