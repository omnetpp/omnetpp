...
\begin{itemize}
  ...
  \item \cclass{cHistogram} is for collecting observations into a histogram.
    \cclass{cHistogram} is highly configurable, suports adding/removing/merging bins
...
Note that bins many not be immediately available during observation
...
\cclass{cAutoRangeHistogramStrategy} is a generic, very configurable histogram 
strategy which creates uniform bins, and creates good quality histograms 
for practical distributions. This strategy uses precollection.
