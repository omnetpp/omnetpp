...
%FIXME add #define EV trick, tale about debug channels etc.
...
subclassing from \cclass{cPolymorphic}, which does not cause any
...
worry at the length of the list: most functions are not
...
If it is not, then it is an error, because then the message is
