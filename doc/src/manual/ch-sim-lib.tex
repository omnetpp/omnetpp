...
There are further \ttt{set..()} functions to assign other value types:
double function with constant args (MathFuncNoArgs, MathFunc1Args, etc),
...
etc. These functions are documented in the API Reference, however, they are
rarely useful for programming simulation models.
