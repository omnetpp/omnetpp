...
%FIXME: remove NED keywords from list!
...
\lstnewenvironment{msg}
    {\lstset{language=MSG,basicstyle=\ttfamily,frame=leftline,framesep=10pt,framerule=3pt,rulecolor=\color{RulerColor},xleftmargin=15pt}}
    {}
\lstnewenvironment{cpp}
    {\lstset{language=C++,basicstyle=\ttfamily,frame=leftline,framesep=10pt,framerule=3pt,rulecolor=\color{RulerColor},xleftmargin=15pt}}
    {}
\lstnewenvironment{inifile}
    {\lstset{language=inifile,basicstyle=\ttfamily,frame=leftline,framesep=10pt,framerule=3pt,rulecolor=\color{RulerColor},xleftmargin=15pt}}
    {}
