...
\lstset{basicstyle=\ttfamily,showstringspaces=false,frame=leftline,framesep=10pt,framerule=3pt,xleftmargin=15pt}

\definecolor{NEDRulerColor}{rgb}{0.8,1.0,0.8}
\definecolor{MSGRulerColor}{rgb}{0.8,1.0,0.8}
\definecolor{CPPRulerColor}{rgb}{0.8,0.8,1.0}
\definecolor{IniRulerColor}{rgb}{0.9,0.9,0.2}
