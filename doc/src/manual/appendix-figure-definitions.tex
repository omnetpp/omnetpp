...
\item[FigureType]: \\
One of the built-in figure types (\ttt{line}, \ttt{arc}, etc.), or
\ttt{custom:\textit{<type>}}. In the latter case, {\opp} looks for
a registered C++ class named \ttt{\textit{<type>}Figure} or
\ttt{c\textit{<type>}Figure} to instantiate.
