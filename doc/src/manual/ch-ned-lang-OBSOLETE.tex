...
\ttt{error} is the bit error rate that specifies the probability
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=4.625in, height=1.297in]{figures/ned-loopconnection}
...
the operands are converted to \ttt{bool} using the C/C++ built-in
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=2.111in, height=1.285in]{figures/ned-hypercube}
