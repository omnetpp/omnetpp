...
letters are \ttt{\{a-zA-Z\}} not \ttt{[a-zA-Z]}) because square brackets
are already reserved for the notation of module vector indices.
...
will use the default specified with \ttt{input()} in the NED files.
...
discussed in Section \ref{sec:ch-run-sim:seedtool}), and you
...
\ttt{\textit{omnetpp-dir}/bitmaps;./bitmaps}.
\end{sloppypar}
