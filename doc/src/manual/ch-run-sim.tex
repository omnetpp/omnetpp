...
\begin{itemize}
  ...
  \item \ttt{\{a-f\}} (set): matches a character in the range a-f
  \item \ttt{\{^a-f\}} (negated set): matches a character NOT in the range a-f
  \item \ttt{\{38..150\}} (numeric range): any number (i.e. sequence of digits)
...
character: \ttt{\{\}a-z\}}, or as a negated set: \ttt{\{^\}a-z\}}. A backslash
...
\subsection{Precedence with wildcards}
