...
-u Cmdenv, or --user-interface=Cmdenv; or whichever is linked

\subsubsection{Loading extra libraries}

uses dlopen() or LoadLibrary()
-l; prefix/suffix to be omitted
or: inifile option
or: maybe not needed, if executable or shared lib was already linked with the shared lib
...
TODO put somewhere: time limits, fingerprinting, and other options!
