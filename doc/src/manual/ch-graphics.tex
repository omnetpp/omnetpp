...
the \fname{setDisplayString()} method so the icon can be changed dynamically based on the
...
(\ttt{bgg=tickdistance,minorpermajorticks,color}). See Figure \ref{fig:graphics-bgtags}.
