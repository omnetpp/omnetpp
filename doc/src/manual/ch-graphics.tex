...
%FIXME update
% isGUI(), displayString().setTagArg(), bubble() etc here!

% implemented bubble() -- submodules
...
The \cclass{cDisplayString} utility class lets...
...
\begin{verbatim}
displayString()->parse("p=100,100;b=60,30,rect;o=red,black,3", true);
\end{verbatim}
...
\begin{verbatim}
parentModule()->backgroundDisplayString()->parse("p=100.....");
\end{verbatim}
...
\begin{verbatim}
gate("out")->displayString()->parse("o=yellow,3");
\end{verbatim}
