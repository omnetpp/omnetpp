...
This section describes the rules \fprop{@display} properties are merged
...
of your main icon. Since display strings can be changed at runtime,
the \ttt{i2} icon can be used to dynamically display the module's current state.
