...
Each tag consists of a key, an equal sign and a comma-separated list of arguments.
...
parameter list. Creating a blue rectangle with default size:
\begin{verbatim}
...
By default modules are represented by simple rectangles, but this can
be overridden with the \ttt{b} tag:
\begin{verbatim}
...
The below example colorize the \ttt{block/source} icon, 20%% red
\begin{verbatim}
