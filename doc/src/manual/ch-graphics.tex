...
via the 3rd and further args of the "p=" tag) will be preserved --
one can think about them as if the those modules were attached
...
it fits on the screen, \textit{unless it contains
