...
%% To update this section, paste src/eventlog/eventlogentries.txt below,
%% and remove XXX, TODO etc lines from it.
%%
%% TODO: many long lines in the following section, as "verbatim" doesn't wrap
