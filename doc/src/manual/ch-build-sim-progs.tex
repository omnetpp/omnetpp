...
\begin{itemize}
    ...
    \item \ttt{-I<dir>} : Additional C++ include directory.
    \item \ttt{-L<dir>} : Add a directory to the library path.
...
feature. Dependent projects may contain header files with conflicting names,
