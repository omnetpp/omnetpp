...
You also need to add to the project the \ttt{_n.cc} files
generated by \ttt{nedtool}. There is an \ttt{AddNEDFileToProject}
...
\end{verbatim}
 ...
 \item \tbf{file name extension}: MSVC 6.0 doesn't recognize \ttt{.cc} files
