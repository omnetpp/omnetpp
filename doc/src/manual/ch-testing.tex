...
That is, \ttt{-u Cmdenv} and \ttt{<inifilenames>} are removed; this allows one
...
\ttt{-mfpmath=sse -msse2}.} Acknowledging this fact, {\opp} lets one list
...
\ftest{\%extraargs} to pass the \ttt{-r <runs>} option to Cmdenv;
