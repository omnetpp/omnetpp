...
writing the eventlog is enabled. To turn on message data recording, supply a value
for the \ttt{eventlog-message-detail-pattern} option in the ini file.
...
\begin{note}
    ...
    files of several gigabytes, and thus fail due to insufficient disk space.
\end{note}
