...
\item[genk\_exponential]: \ttt{double genk\_exponential(double, double)} \\
\item[genk\_intuniform]: \ttt{double genk\_intuniform(double, double, double)} \\
\item[genk\_normal]: \ttt{double genk\_normal(double, double, double)} \\
\item[genk\_truncnormal]: \ttt{double genk\_truncnormal(double, double, double)} \\
\item[genk\_uniform]: \ttt{double genk\_uniform(double, double, double)} \\
