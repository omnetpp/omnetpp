...
\tab Andr\'{a}s Varga\tab \tab andras.varga@omnest.com, andras@omnetpp.org
...
As of today, practically all contributed code has been replaced
or rewritten by Andr\'{a}s Varga.
...
JAR compiler (later renamed nedc), sample simulations; summer 1995:\\
