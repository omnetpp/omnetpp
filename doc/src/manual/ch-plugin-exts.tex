...
const char *getAsCustom(cConfigKey *entry, const char *fallbackValue=NULL);
bool getAsBool(cConfigKey *entry, bool fallbackValue=false);
long getAsInt(cConfigKey *entry, long fallbackValue=0);
double getAsDouble(cConfigKey *entry, double fallbackValue=0);
std::string getAsString(cConfigKey *entry, const char *fallbackValue="");
std::string getAsFilename(cConfigKey *entry);
std::vector<std::string> getAsFilenames(cConfigKey *entry);
std::string getAsPath(cConfigKey *entry);
