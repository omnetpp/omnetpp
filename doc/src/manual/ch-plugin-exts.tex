...
\cclass{cOutputScalarManager} handles recording the scalar output data.
The default output scalar manager is \cclass{cFileOutputScalarManager},
defined in the Envir library.
...
\cclass{cOutputVectorManager} handles recording the output from \cclass{cOutVector} objects.
...
\cclass{cSnapshotManager} provides an output stream to which snapshots are written
...
their behaviour. One method that you will surely want to reimplement is
