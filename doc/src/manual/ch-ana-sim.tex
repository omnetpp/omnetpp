...
\textit{<module-full-path>.<statistic-name>.}\ttt{result-recording-mode=}
configuration option. If \ttt{result-recording-mode=} is not defined
...
FIXME: "vector" should be listed in modehint or in recording-mode
...
\ttt{vector-recording-intervals=} per-object options. The syntax of the
...
For the \ttt{vector-recording-intervals=} option, one can specify
