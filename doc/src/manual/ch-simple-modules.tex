...
avaiable. In contrast, \ffunc{initialize()} is called just before the
...
Let us write another bursty traffic generator. It will have two
...
\begin{itemize}
  ...
  \item \ffunc{listenerAdded()}, \ffunc{listenerRemoved()} are called
...
\ttt{histogram}; the complete list is given in \ref{sec:ana-sim:scalar-results}.
