...
\cclass{cEventHeap} class, but knowledge of the FES implementation is
...
Every component (module and channel) in the network has a unique ID that
...
object, \cclass{cSimulation}. \ffunc{getComponent()} expects an ID, and
...
submodule and the \ttt{gen} submodule of \ttt{app[3]} submodule of the
module in question:
...
functions to create a channel instance. Alternatively, one can use
