...
\cclass{cGate} has two methods

                                from               to
Simple module output gate        NULL      sibling module input gate, or
                                           parent module output gate
Simple module input gate   sibling module output gate,
                           or parent module input gate  NULL
Comound module output gate
