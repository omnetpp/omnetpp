...
is part of {\opp}. It does a standard C++ \ttt{dynamic_cast},
...
in the first place? The simulation kernel always has to know which
...
Another reason is that the Tkenv simulation GUI can animate
method calls, but to be able to do that, it has to know about them.
