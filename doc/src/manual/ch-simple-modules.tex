...
\begin{description}
  ...
  \item[timeavg]: record the time average, interpreting the signal as a
      step function (sample-hold)
  \item[stddev]: record the count, sum, mean, standard deviation, minimum
      and maximum of the values
  \item[histogram]: record everything the stddev records, plus a histogram
