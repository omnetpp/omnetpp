...
\ttt{@statistic} properties on its NED declaration. The runtime iterates on
...
does not specify it, the \ttt{record=} property key will be used.
...
Possible values for \ttt{record} include \ttt{vector}, \ttt{count}, \ttt{last},
