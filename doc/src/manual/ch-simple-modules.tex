...
in the first place? If the simulation FIXME
...
modules. These calls perform context switching, and notify the simulation
GUI so that animation of the method call can take place.
