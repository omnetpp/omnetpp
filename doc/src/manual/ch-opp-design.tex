...
You probably do not want to keep the appearance of the simulation program, so you
...
That is, when the simulation program starts up, a new \cclass{cModuleType}
