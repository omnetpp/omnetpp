...
Parameters are defined and assigned in the \fkeyword{parameters} section
...
Parameters can only be defined in component types, but not in submodules
and connections. In submodules and connections, one can only assign
existing parameters.
