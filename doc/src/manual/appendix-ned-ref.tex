...
\begin{note}
That is, an identifier in a submodule's body will be interpreted as
a parameter of the enclosing compound module, \textit{not} that of the
submodule.
\end{note}

Exception: if a variable occurs in a connection \ttt{for} loop and names
