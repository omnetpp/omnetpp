...
\begin{itemize}
  ...
  \item{\textbf{Envir} is another library which contains all code
    ...
    (see sections \ref{sec:ch-embedding:customization} and
...
\begin{itemize}
  ...
  \item{\textbf{Executing Model $\Leftrightarrow$ Envir}. The \ttt{ev} object, logically
  ...
  \item{\textbf{Envir $\Leftrightarrow$ Tkenv and Cmdenv}. Envir defines \cclass{TOmnetApp}
