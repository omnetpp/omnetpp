...
\begin{itemize}
  ...
  \item{\textbf{Envir $\Leftrightarrow$ Tkenv and Cmdenv}. Tkenv and Cmdenv
...
int main(int argc, char *argv[])
{
    ...
    // load NED files
    simulation.loadNedSourceFolder("./ned-core");
    simulation.loadNedSourceFolder("./ned-ext");
...
The \ttt{simulate()} function for the above code:
...
\section{Installing a custom scheduler}
...
own scheduler class), add a \fname{setScheduler()} call into \fff{main()}:
