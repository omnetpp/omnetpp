...
square brackets after the property name. The index tells multiple
properties with the same name apart, while staying out of the way (the code
that interprets properties may choose to ignore the index strings
altogether).

\begin{Verbatim}
XXX @statistic[bubu](type=count;label="sdsadsad");
XXX @statistic[bubu](type=double;unit=s;label="fdsfdsf");
\end{Verbatim}
