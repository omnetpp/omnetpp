...
The opp\_nedtool command uses XSLT to produce HTML documentation
from the given NED files, much like Javadoc or Doxygen.
   \footnote{You're going to need xsltproc (part of libxml/libxslt)
...
The output file is called \ttt{neddoc.html}. opp\_nedtool can be
