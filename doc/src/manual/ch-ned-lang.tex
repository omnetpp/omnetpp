...
Our hypothetical network consists of nodes. One each node there is an
...
This example declares two statistics as \ttt{@signal} properties,
\ttt{@signal[eed]} and \ttt{@signal[jitter]}. Property values within
...
\ttt{"signal"} property, and it will return a list containing
\ttt{"eed"} and \ttt{"jitter"}).

In the \ttt{@signal} example the index was textual and meaningful,
...
to be part of the value, use double quoting:
...
\ttt{inet.mobility.MassMobility}; and suppose that there is also a type
