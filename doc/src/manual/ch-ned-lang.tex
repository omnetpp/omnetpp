...
Compound module types like \ttt{Node} are composed of one or more submodules,
listed under the \ttt{submodules:} section of the declaration.
...
XXX submodule vector! gate vector!
...
Connections...  XXX elaborate -->, <-->, "for" etc.
