...
%FIXME!!
\begin{itemize}
  \item \ttt{/} -- the root element
  \item \ttt{/foo} -- first <foo> child of the root element
  \item \ttt{/foo/bar} -- first <bar> child of first <foo> child of the root element
  \item \ttt{//bar} -- first <bar> anywhere (depth-first search!)
  \item \ttt{/*/bar} -- first <bar> child two levels below root element
  ...
  \item \ttt{//bar[1]} -- a <bar> anywhere under the root element which is the second <bar> among its siblings
  \item \ttt{//*[@color='yellow']} -- an element under the root element with attribute color="yellow"
  \item \ttt{//*[@color='yellow']/foo/bar} -- first <bar> child of first <foo> child of a "yellow-colored" node
\end{itemize}
