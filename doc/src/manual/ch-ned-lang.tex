...
parameters:\index{module!parameter declaration} section of a
...
\fpar[ned!keywords!xml]{xml}. (The last one, \ttt{xml} makes external XML files
...
expression\index{ned!expression}. One is advised to write the
...
\begin{verbatim}
cXMLElement *rootelement = par("xmlparam").asXML();
\end{verbatim}
...
% FIXME introduce omnetpp.ini and param assignments somewhere before this point
