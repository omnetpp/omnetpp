...
The \ttt{sendIaTime} parameter is decorated with \ttt{@unit(s)}. This means
...
will not be accepted. The \ttt{packetLength} parameter, which has the unit
\ttt{byte}, accepts values in \ttt{KB}, \ttt{kilobyte}, \ttt{MB}, etc.
