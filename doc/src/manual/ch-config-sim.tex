...
How does it work? First of all, Cmdenv with the \fopt{-x} option will print
...
When the \fopt{-g} option is also added, the program also prints the values
of the iteration variables for each run. (Use \fopt{-G} for even more info.)
