 ...
 * @ingroup Internals
 */
class SIM_API cNEDDeclaration : public cNoncopyableObject
{
  public:
    /**
  ...
  public:
     ...
     * Constructor.
     */
    cNEDDeclaration(const char *name);
    ...
    /**
     * Finds a registered NED declaration by name.
     */
    static cNEDDeclaration *find(const char *name);
};
