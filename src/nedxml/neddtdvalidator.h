...
class NEDDTDValidator : public NEDDTDValidatorBase
{
  public:
    ...
    virtual void validateElement(SimpleNode *node);
    virtual void validateElement(InterfaceNode *node);
    virtual void validateElement(ModuleNode *node);
    virtual void validateElement(ParametersNode *node);
    virtual void validateElement(ParametersBlockNode *node);
    ...
    virtual void validateElement(GateBlockNode *node);
    ...
    virtual void validateElement(ConnectionBlockNode *node);
