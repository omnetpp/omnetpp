...
class ENVIR_API StatisticRecorderParser
{
  protected:
    ...
    SignalSource createFilterOrRecorder(FilterOrRecorderReference *filterOrRecorderRef, const std::vector<Expression::Elem>& stack, int len, const SignalSource& source);
  public:
