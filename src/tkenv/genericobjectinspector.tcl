...
proc GenericObjectInspector:onSetObject {insp} {
    ...
    set showContentsPage  [lcontains {cArray cQueue cMessageHeap cSimpleModule cModule cChannel cRegistrationList cSimulation cMessage} $type]
    set focusContentsPage [lcontains {cArray cQueue cMessageHeap cSimpleModule cModule cChannel cRegistrationList} $type]
