...
class Pt
{
    ...
    public:
	    ...
	    Pt getRadial(double radius, double angle) {
...
class Rs {
    ...
    public:
        ...
        void assign(double width, double height) {
		    this->width = width;
		    this->height = height;
        }
...
class Cc {
    ...
    public:
        ...
        void assign(Pt& origin, double radius) {
		    this->origin = origin;
		    this->radius = radius;
        }
