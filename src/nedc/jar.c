...
#define JAR_VERSION "2.0.0 (build #112)"
...
int main (int argc, char *argv [])
{
        ...
        if (argc < 2)
        {
                ...
                * print help text
                */
                printf( "NEDC " JAR_VERSION ": OMNeT++ Network description compiler"
                        " (formerly: JAR)\n"
                        "  Author:                  Andras Varga (TU Budapest)\n\n"
                        "  Original implementation: Jan Heijmans (TU Delft)\n"
                        "                           Alex Paalvast (TU Delft)\n"
                        "                           Robert van der Leij (TU Delft)\n"
                        "  Parallel exec. support:  Gabor Lencse (TU Budapest)\n\n"
                        "Usage: nedc [-v] [-i includepath -i ...] "
                        "nedfile1 nedfile2 ...\n"
                        "Output filename is generated by appending '_n.cc' to the base filename:\n"
                        "  foo.ned --> foo_n.cc\n"
                      );
        }
        else
