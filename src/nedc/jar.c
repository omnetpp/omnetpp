...
#define NEDC_VERSION       0x2000
#define NEDC_VERSION_TEXT "2.0"
...
void print_header (FILE *f)
{
        ...
        fprintf (f, "//-----------------------------------------\n");
        fprintf (f, "//\n");
        fprintf (f, "// Generated by NEDC version " NEDC_VERSION_TEXT "\n");
        ...
        fprintf (f, "// Version check\n"
                    "#define NEDC_VERSION " #NEDC_VERSION
...
int main (int argc, char *argv [])
{
        ...
        if (argc < 2)
        {
                ...
                * print help text
                */
                printf( "NEDC " NEDC_VERSION_TEXT "- part of OMNeT++. (c) 1992,99 Andras Varga, TU Budapest\n"
