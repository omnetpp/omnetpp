...
cStructDescriptor::cStructDescriptor(_CONST cStructDescriptor& cs)
{
...
cObject *cStructDescriptor::dup() _CONST
{
    opp_error(eCANTDUP);
    return NULL;
}

cStructDescriptor& cStructDescriptor::operator=(_CONST cStructDescriptor& cs)
{
