...
cProperties *cDynamicModuleType::subcomponentProperties(const char *subcomponentname) const
{
    return NULL;
}

cProperties *cDynamicModuleType::subcomponentParamProperties(const char *subcomponentname, const char *paramname) const
{
    return NULL;
}

cProperties *cDynamicModuleType::subcomponentGateProperties(const char *subcomponentname, const char *gatename) const
{
    return NULL;
}
