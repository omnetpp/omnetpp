                                       ...
                                       bool isplusplus)
{
    ...
    if (!gateindexp && !isplusplus)
    {
        ...
        if (!gatep)
            throw cRuntimeError("dynamic module builder: module (%s)%s has no gate `%s'",
    ...
    else // (gateindexp)
    {
        ...
        if (!gatep)
            throw cRuntimeError("dynamic module builder: module (%s)%s has no gate `%s[%d]'",
