...
//   Rewrite,syncpoints: Andras Varga, 1996-97
//
//   Contents:
...
class cNetGate : public cGate
{
        ...
        public:
         ...
         cNetGate(char *s, int tp);
         virtual ~cNetGate()    {}
         virtual char *isA()    {return "cNetGate";}
...
class cPvmMod : public cNetMod
{
        ...
        public:
         cPvmMod();
         virtual ~cPvmMod();
         virtual char *isA() {return "cPvmMod";}
         ...
         virtual void putmsg_onconsole(char *s);
         virtual void puts_onconsole(char *s);
         virtual bool gets_onconsole(char *promptstr, char *buf, int len);
