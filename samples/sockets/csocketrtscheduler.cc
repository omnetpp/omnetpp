...
Register_GlobalConfigEntry(CFGID_SOCKETRTSCHEDULER_PORT, "socketrtscheduler-port", "General", CFG_INT,  4242, "When cSocketRTScheduler is selected as scheduler class: the port number cSocketRTScheduler listens on.");
